          ...
          <div className="hidden lg:flex items-center space-x-3">
            ...
            <Link href="/signin">
              <Button
                variant="outline"
                size="sm"
                className="!bg-transparent !border-blue-300 !text-green-100 hover:!bg-blue-800/50 hover:!text-white transform hover:scale-105 transition-all duration-300 bg-transparent"
              >
                {t("signIn")}
              </Button>
            </Link>
