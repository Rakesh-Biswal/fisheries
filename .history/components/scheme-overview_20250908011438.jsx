...
const schemes = [
  {
    ...
    status: "live",
    applicants: 1250,
    backgroundImage: "/modern-fish-farming-pond-with-healthy-fish-swimmin.jpg",
  },
  {
    id: 2,
    ...
    status: "expiring",
    applicants: 890,
    backgroundImage: "/fisheries-infrastructure-equipment--fish-processin.jpg",
  },
  {
    id: 3,
    ...
    status: "expired",
    applicants: 650,
    backgroundImage: "/integrated-fisheries-value-chain--fish-market--sea.jpg",
  },
]
          ...
          {schemes.map((scheme, index) => (
            ...
            >
              <div className="absolute inset-0 overflow-hidden rounded-2xl">
                <img
                  src={scheme.backgroundImage || "/placeholder.svg"}
                  alt={`${scheme.title} background`}
                  className="w-full h-full object-cover transition-all duration-700 group-hover:scale-110 group-hover:rotate-2 opacity-20 group-hover:opacity-30"
                />
                <div className="absolute inset-0 bg-gradient-to-br from-white/80 via-white/60 to-white/40 group-hover:from-white/70 group-hover:via-white/50 group-hover:to-white/30 transition-all duration-700"></div>
                <div className="absolute inset-0 bg-gradient-to-t from-primary/10 via-transparent to-blue-100/20 group-hover:from-primary/20 group-hover:to-blue-200/30 transition-all duration-700"></div>
              </div>
