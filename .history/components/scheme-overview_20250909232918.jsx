      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 mt-2">
            Discover trusted subsidy schemes and apply with confidence
          </p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {schemes.map((scheme) => (
            <Card key={scheme.id} className="border rounded-xl shadow-sm hover:shadow-md transition-all bg-white">
              <CardHeader>
