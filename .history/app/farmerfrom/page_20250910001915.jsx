...
<div className="flex flex-col items-center">
  {/* Preview Box with dark border */}
  <div className="w-32 h-32 border-2 border-gray-700 rounded-md flex items-center justify-center overflow-hidden bg-gray-100">
    {formData.photo ? (
      <img
  ...
  <input
    ...
    onChange={(e) => {
      ...
      if (file && file.size > 1024 * 1024) {
        setErrors({ ...errors, photo: "File size must be less than 1 MB" });
    ...
    className="mt-3 block w-full text-sm text-gray-700 border rounded-md cursor-pointer focus:outline-none"
  />
