// components/Farmer_Components/payment-submission-form.js
"use client";
...
// Cloudinary upload function for farmer side
...
export default function FarmerPaymentSubmissionForm({ 
    paymentId, 
    onSuccess, 
    onClose 
}) {
    ...
    const submitPaymentProof = async () => {
        ...
        try {
            ...
            // Submit payment proof using farmer route
            const submitResponse = await fetch(`${API_URL}/api/farmer/payments/${paymentId}/submit`, {
                method: 'POST',
                headers: {
